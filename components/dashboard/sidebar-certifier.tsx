...
import { CheckSquare, Settings, Wallet, Copy, LogOut, ShoppingCart, ScrollText } from "lucide-react"
...
const nav = [
  { href: "/dashboard/certifier", label: "Certifier Dashboard", icon: CheckSquare },
  { href: "/dashboard/buyer", label: "Marketplace", icon: ShoppingCart },
  { href: "/dashboard/certifier/history", label: "Certification History", icon: ScrollText },
  { href: "/dashboard/settings", label: "Settings", icon: Settings },
]

export default function SidebarCertifier() {
